...
export default function CampaignSideBar({ brandGuideline }: { brandGuideline: BrandGuideline | null }) {
  return (
          ...
          <div className="border shadow-sm rounded-lg p-2">
            ...
            <div className="grid gap-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <Label className="text-base" htmlFor="from-date">
                    From Date
                  </Label>
                  <Input id="from-date" type="date" />
                </div>
                <div>
                  <Label className="text-base" htmlFor="to-date">
                    To Date
                  </Label>
            ...
            <Table>
              ...
              <TableBody>
                <TableRow>
                  ...
                  <TableCell>2022-02-20</TableCell>
